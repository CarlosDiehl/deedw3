      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-white">¿Comó funciona nuestro servicio?</h2>
            <p className="text-xl text-gray-600">Traemos herramientas de la blockchain para dar valor a caso de usos reales en los Bienes Raíces.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Se crea el Invoice</h4>
              <p className="text-gray-600 text-center">Se crea el invoice en blockchain con los montos y la documentación.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Se envian las Cryptos</h4>
              <p className="text-gray-600 text-center">Comprador envia las criptomonedas al Smart Contract, "La bóveda".</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Transferencia de la propiedad</h4>
              <p className="text-gray-600 text-center">Se hace el intercambio de la propiedad tal y cual fue pactado.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Validación de las partes</h4>
              <p className="text-gray-600 text-center">Las partes validan que la transferencia fue exitosa con sus wallets.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Smart Contract finaliza</h4>
              <p className="text-gray-600 text-center">El SC libera automaticamente el pago a la wallet del vendedor.</p>
            </div>
